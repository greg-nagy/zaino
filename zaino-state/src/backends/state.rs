...
use zaino_fetch::{
    ...
    jsonrpsee::{
        ...
        response::{
            block_deltas::{BlockDelta, BlockDeltas},
            block_subsidy::GetBlockSubsidy,
            mining_info::GetMiningInfoWire,
            peer_info::GetPeerInfo,
            BlockObject, GetMempoolInfoResponse, GetNetworkSolPsResponse, GetSubtreesResponse,
        },
    },
};
        ...
        match zblock {
            GetBlock::Object(boxed_block) => {
                Ok(BlockDeltas {
                    ...
                    // TODO: Implement
                    mediantime: boxed_block.time().expect("time should be present"),
                    ...
                    nextblockhash: match boxed_block.next_block_hash() {
                        None => Some("".to_string()),
